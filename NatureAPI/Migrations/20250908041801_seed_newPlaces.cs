...
{
    /// <inheritdoc />
    public partial class seed_newPlaces : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Waterfall", new DateTime(2025, 9, 8, 4, 17, 55, 172, DateTimeKind.Utc).AddTicks(6099), "One of the most spectacular waterfalls in San Luis Potosí, with turquoise waters surrounded by jungle.", 300, 50.0, 21.750699999999998, -99.154200000000003, "Cascada de Tamul", "08:00-18:00" },
